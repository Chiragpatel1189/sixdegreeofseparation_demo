...
import { ConnectionPaths, ConnectionSelection, ConnectionWrapper, UserNode } from "./styles";
...
const MakeRelationship = ({ allusers }) => {
    ...
    const getConnectionsHandler = () => {
        ...
        function calculateRelations(personOne, personTwo, path = [personOne], visited = {}) {
                    ...
                    <>
                                    ...
                                    {allusers.map(item => {
                                        return (
                                            <UserNode
                                                ...
                                                className={`${personTwo === item.name ? "selected" : ""} ${
                        ...
                        {personOne !== "" && personTwo !== "" ? (
                            <>
                                ...
                                <div>
                                    <p>
                                        Get connection path between <strong>{personOne}</strong> and <strong>{personTwo}</strong>.
                                    </p>
                                </div>
                            </>
                        ) : null}
